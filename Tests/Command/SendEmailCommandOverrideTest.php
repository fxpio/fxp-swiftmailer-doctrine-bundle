...
final class SendEmailCommandOverrideTest extends TestCase
{
    ...
    public function testInvalidMailerName(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('The mailer "invalid" does not exist');
    ...
    public function testDisabledMailers(): void
    {
     ...
     */
    public function testEnabledMailer($timeout): void
    {
        $this->container->expects($this->at(0))
            ->method('getParameter')
            ->with($this->equalTo('swiftmailer.mailers'))
